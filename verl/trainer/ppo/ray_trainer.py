    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            for _ in range(num_samples):
                ...
                all_sample_outputs.append(output_texts)
                ...
                all_sample_scores.append(scores)
            ...
            # Compute average outputs and scores
            avg_sample_outputs = [" ".join([all_sample_outputs[j][i] for j in range(num_samples)]) for i in range(len(all_sample_outputs[0]))]
            avg_sample_scores = [sum(all_sample_scores[j][i] for j in range(num_samples)) / num_samples for i in range(len(all_sample_scores[0]))]

            sample_outputs.extend(avg_sample_outputs)
            sample_scores.extend(avg_sample_scores)
