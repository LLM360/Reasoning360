#!/bin/bash
#SBATCH --job-name=rl-32b-k2think-continue-data5_1_all_dapo_dalu
#SBATCH --nodes=32
#SBATCH --ntasks=32
...
RESUME_CKPT_DIR_NAME="/lustrefs/users/haonan.li/Reasoning360/checkpoints/DALU/370860-rl-32b-k2think-continue-data5_1_all_dapo_dalu-K2-Think"  # Fill in the checkpoint directory name to resume from, otherwise from scratch
WANDB_ID="0htstb7e"
