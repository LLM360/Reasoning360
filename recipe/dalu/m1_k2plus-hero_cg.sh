...
# =================== Cluster Environment ===================
export CONDA_BIN_PATH=/lustrefs/users/chengqian.gao/miniconda3/envs/sync-rl-v2/bin/
...
TRAIN_DATA_DIR=/lustrefs/users/chengqian.gao/k2plus-rl-datasets/dataset-palu
...
for dataset in "${dataset_names[@]}"; do
    file_path="${TRAIN_DATA_DIR}/${dataset}"
    if [ -f "$file_path" ]; then
...
# test_files="['${math_test_path}','${aime_test_path}','${aime25_test_path2}','${amc_test_path}','${humaneval_test_path}','${mbpp_test_path}','${livecodebench_test_path}','${nemotron_test_path}','${gpqa_diamond_test_path}','${supergpqa_test_path}','${if_test_path}','${if_bench_test_path}']"
test_files="['${math_test_path}']"


# =================== Model ===================
BASE_MODEL=/lustrefs/users/varad.pimpalkhute/data_process/K2-Plus-Oss-Instruct-mid4
...
srun --nodes=1 --ntasks=1 -w "$head_node" --export=ALL \
    /usr/bin/env -u ROCR_VISIBLE_DEVICES -u HIP_VISIBLE_DEVICES \
