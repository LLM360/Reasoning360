...
class RLHFDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        for parquet_file in self.data_files:
            ...
            # NOTE: maybe use polars? Previous version Reasoning360 uses pl.read_parquet(parquet_file) if fails
        ...
        if self.filter_overlong_prompts:
            ...
            self.dataframe = self.dataframe.filter(
                # NOTE: added by Reasoning360. If no chat template, use raw prompt.
                lambda doc: len(
