...
if [[ -n "$RESUME_CKPT_DIR_NAME" ]]; then
    ...
    WANDB_EXPERIMENT_NAME="Qwen3-0.6B-32kgen-bs128-rollout8-${TIMESTAMP}-${BASE_MODEL##*/}"
fi
...
dynamic_sft_rl_advantage_threshold=0.0  # Use SFT if advantage <= this value, otherwise use RL
