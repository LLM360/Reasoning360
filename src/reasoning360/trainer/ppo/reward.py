...
from reasoning360.utils.reward_score import default_compute_score
...
def load_reward_manager(
    ...
    if reward_manager_cfg.source == "register":
        # Use verl's registry to avoid name-collisions between verl and local Reasoning360
        # reward manager implementations (both may register e.g. "dapo").
