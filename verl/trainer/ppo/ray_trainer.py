...
class RayPPOTrainer(object):
    ...
    def _partial_rollout_add_from_dataloader_for_rollout(self, data_iter, replay_gen_batch):
        ...
        if new_batch is not None:
            ...
            batch = self._concat_with_left_padding(replay_gen_batch, new_batch)
    ...
    def _concat_with_left_padding(self, left: DataProto, right: DataProto):
        ...
        for key in ["input_ids", "attention_mask", "position_ids"]:
            ...
            if seq_len_left < seq_len_right:
                ...
                left.batch[key] = F.pad(left.batch[key], (0, pad_left), value=pad_value)
            ...
            if use_partial_rollout:
                ...
                while not epoch_done:
                    ...
                    with _timer("step", timing_raw):
                        ...
                        batch = self._concat_with_left_padding(replay_buffer_full, batch)
                        ...
                        if chunked_size > 0:
                            ...
                            # TODO: in this way, timing should be accumulated to the next step.
                            continue
