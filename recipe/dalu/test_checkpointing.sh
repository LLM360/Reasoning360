#!/bin/bash
#SBATCH --job-name=debug_chengqian
#SBATCH --nodes=4
#SBATCH --ntasks=4
...
# Math (test)
math_test_path=${TEST_DATA_DIR}/math_500_x10.parquet
aime24_test_path=${TEST_DATA_DIR}/aime24_x32.parquet
...
test_files="['${aime24_test_path}']"  # Use math as example, add to more tasks as needed

# =================== Model ===================
BASE_MODEL=deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B
# CONDA_BIN_PATH=/lustrefs/users/haonan.li/miniconda3/envs/verl0.5/bin/
...
temperature=1.0
top_p=1.0
top_k=-1 # 0 for HF rollou¸¸t, -1 for vLLM rollout
