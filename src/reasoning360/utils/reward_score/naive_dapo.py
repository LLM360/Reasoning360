    ...
    if os.name == "posix":
        ...
        def decorator(func):
            ...
            def wrapper(*args, **kwargs):
                # Python signals can only be installed/handled in the main thread.
                # Reward scoring may run inside ThreadPoolExecutor (e.g., async reward loop),
                # so avoid SIGALRM in worker threads instead of crashing.
