...
from reasoning360.trainer.ppo.ray_trainer import RayPPOTrainer, apply_kl_penalty, compute_advantage, compute_response_mask
                ...
                with marked_timer("step", timing_raw):
                    ...
                    if self.config.algorithm.adv_estimator == AdvantageEstimator.REMAX:
                        ...
                        with marked_timer("gen_max", timing_raw, color="purple"):
                            ...
                            # Remove overlapping keys before union
                            baseline_keys = set(gen_baseline_output.batch.keys())
                            batch_keys_set = set(batch.batch.keys())
                            for key in (baseline_keys & batch_keys_set):
