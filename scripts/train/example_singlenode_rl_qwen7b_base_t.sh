...
export STEM_LLM_JUDGE_URL=""  # Fill in the llm-as-judge hosted URL, currently used only in 'STEM' domain
...
# =================== Model ===================
BASE_MODEL=Qwen/Qwen2.5-7B-instruct # Note: this is Qwen32B-Base model with 'think' system prompt
# =================== Wandb ===================
