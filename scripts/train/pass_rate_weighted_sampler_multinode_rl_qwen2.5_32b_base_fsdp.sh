...
TRAIN_DATA_DIR=/mnt/weka/shrd/k2tls/jalaj/data-mixtures_round2/medium/data_mix_math_9000/main_questions
...
# math_train_path=${TRAIN_DATA_DIR}/math__combined_118.2k.part1_scored.parquet
# math_train_path2=${TEST_DATA_DIR}/math__combined_118.2k.part2_scored.parquet
...
WANDB_EXPERIMENT_NAME=Curriculum-${SLURM_JOB_ID}-${SLURM_JOB_NAME}-${BASE_MODEL##*/}
...
# =================== Start RL training ===================
# These arguments enable pass-rate based weighted sampling
